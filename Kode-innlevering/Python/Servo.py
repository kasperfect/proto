...
class Servo:
    ...
    def __init__(self, port):
        ...
        self.closed = 8.5 #Servo Dutycycle hvor servoen staar i lukket posisjon
...
class Lid:
    """Klasse som styrer hele aapne/lukke-mekanismen til ROBO. Bruker Servo-klassen til aa styre servoene. Se over i koden."""
